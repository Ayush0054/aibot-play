...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between px-24 py-5">
      <h1 className="text-5xl font-sans">IDK</h1>

      <div className="flex  h-[35rem] w-[40rem] flex-col items-center  rounded-xl">
      ...
      resize-none overflow-y-auto text-black bg-gray-300 rounded-l outline-none"
          ...
          <button
            ...
            className="w-[15%] bg-slate-800 px-4 py-2 rounded-r"
          >
            send
          </button>
        </div>
